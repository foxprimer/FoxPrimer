use utf8;
package FoxPrimer::Schema::Result::Chromosomesize;
...
=head1 TABLE: C<chromosomesizes>

=cut

__PACKAGE__->table("chromosomesizes");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:27vTxyjzM6YGrlFacSEzPA
