...
package FoxPrimer::Model::Updated_Primer3_Run;
...
BEGIN { 
	$PROGRAMNAME = 'primer3';
	@PRIMER3_PARAMS=qw( PROGRAM SEQUENCE_EXCLUDED_REGION SEQUENCE_INCLUDED_REGION
 P3_COMMENT PRIMER_DNA_CONC PRIMER_EXPLAIN_FLAG P3_FILE_FLAG
 PRIMER_FIRST_BASE_INDEX PRIMER_GC_CLAMP
 PRIMER_INTERNAL_DNA_CONC SEQUENCE_INTERNAL_EXCLUDED_REGION
 SEQUENCE_INTERNAL PRIMER_INTERNAL_MAX_GC
 PRIMER_INTERNAL_MAX_LIBRARY_MISHYB PRIMER_INTERNAL_MAX_POLY_X
 PRIMER_INTERNAL_MAX_SIZE PRIMER_INTERNAL_MAX_TM
 PRIMER_INTERNAL_MIN_GC PRIMER_INTERNAL_MIN_QUALITY
 PRIMER_INTERNAL_MIN_SIZE PRIMER_INTERNAL_MIN_TM
 PRIMER_INTERNAL_MISHYB_LIBRARY
 PRIMER_INTERNAL_OPT_GC_PERCENT PRIMER_INTERNAL_OPT_SIZE
 PRIMER_INTERNAL_OPT_TM PRIMER_INTERNAL_SALT_MONOVALENT
 PRIMER_INTERNAL_MAX_SELF_ANY PRIMER_INTERNAL_MAX_SELF_END
 PRIMER_INTERNAL_WT_SELF_ANY PRIMER_INTERNAL_WT_SELF_END PRIMER_IO_WT_END_QUAL
 PRIMER_INTERNAL_WT_GC_PERCENT_GT PRIMER_INTERNAL_WT_GC_PERCENT_LT
 PRIMER_INTERNAL_WT_NUM_NS PRIMER_IO_WT_REP_SIM PRIMER_INTERNAL_WT_SEQ_QUAL
 PRIMER_INTERNAL_WT_SIZE_GT PRIMER_INTERNAL_WT_SIZE_LT PRIMER_INTERNAL_WT_TM_GT
 PRIMER_INTERNAL_WT_TM_LT SEQUENCE_PRIMER PRIMER_LIBERAL_BASE
 PRIMER_PAIR_MAX_DIFF_TM PRIMER_MAX_END_STABILITY PRIMER_MAX_GC
 PRIMER_MAX_LIBRARY_MISPRIMING PRIMER_MAX_POLY_X PRIMER_MAX_SIZE PRIMER_MAX_TM
 PRIMER_MIN_END_QUALITY PRIMER_MIN_GC PRIMER_MIN_QUALITY
 PRIMER_MIN_SIZE PRIMER_MIN_TM PRIMER_MISPRIMING_LIBRARY
 PRIMER_MAX_NS_ACCEPTED PRIMER_NUM_RETURN PRIMER_OPT_GC_PERCENT
 PRIMER_OPT_SIZE PRIMER_OPT_TM PRIMER_PAIR_MAX_LIBRARY_MISPRIMING
 ...
 PRIMER_PAIR_WT_PR_PENALTY PRIMER_PAIR_WT_LIBRARY_MISPRIMING PRIMER_PICK_ANYWAY
 PRIMER_PICK_INTERNAL PRIMER_PRODUCT_MAX_TM
 PRIMER_PRODUCT_MIN_TM PRIMER_PRODUCT_OPT_SIZE PRIMER_PRODUCT_OPT_TM
 PRIMER_PRODUCT_SIZE_RANGE PRIMER_QUALITY_RANGE_MAX
 PRIMER_QUALITY_RANGE_MIN SEQUENCE_PRIMER_REVCOMP PRIMER_SALT_MONOVALENT
 PRIMER_MAX_SELF_ANY PRIMER_MAX_SELF_END SEQUENCE_ID
 SEQUENCE_QUALITY SEQUENCE_START_CODON_POSITION PRIMER_TASK
 PRIMER_WT_SELF_ANY PRIMER_WT_SELF_END PRIMER_WT_END_QUAL
 PRIMER_WT_END_STABILITY PRIMER_WT_GC_PERCENT_GT
 PRIMER_WT_GC_PERCENT_LT PRIMER_WT_NUM_NS PRIMER_WT_POS_PENALTY
 PRIMER_WT_LIBRARY_MISPRIMING PRIMER_WT_SEQ_QUAL PRIMER_WT_SIZE_GT
 PRIMER_WT_SIZE_LT PRIMER_WT_TM_GT PRIMER_WT_TM_LT SEQUENCE_TEMPLATE SEQUENCE_TARGET 
...
sub new {
	...
	if ($args{'-seq'}) {
		...
		my @input;
		push (@input, ("SEQUENCE_ID=".$self->{'seqobject'}->id),
...
sub add_targets {
	...
	foreach my $key (keys %args) {
		...
		if (uc($key) eq "SEQUENCE_INCLUDED_REGION") {
...
sub _input_args {
	...
	my %hash=(
	'SEQUENCE_ID'=>'(string, optional) an id. Optional. Note must be present if P3_FILE_FLAG is set',
  'SEQUENCE_TEMPLATE'=>'(nucleotide sequence, REQUIRED) The sequence itself. Cannot contain newlines',
  'SEQUENCE_INCLUDED_REGION'=>'(interval, optional) Where to pick primers from. In form <start>,<length>. Based on zero indexing!',
  'SEQUENCE_TARGET'=>'(interval list, default empty) Regions that must be included in the product. The value should be a space-separated list of <start>,<length>',
  'SEQUENCE_EXCLUDED_REGION'=>'(interval list, default empty) Regions that must NOT be included in the product. The value should be a space-separated list of <start>,<length>',
  'P3_COMMENT'=>'(string) This is ignored, so we will just save, and return it',
  'SEQUENCE_QUALITY'=>'(quality list, default empty) A list of space separated integers with one per base. Could adapt a Phred object to this.',
  'SEQUENCE_PRIMER'=>'(nucleotide sequence, default empty) If you know the left primer sequence, put it here',
  'SEQUENCE_PRIMER_REVCOMP'=>'(nucleotide sequence, default empty) If you know the right primer sequence, put it here',
  'SEQUENCE_START_CODON_POSITION'=>'(int, default -1000000) Location of known start codons for designing in frame primers.',
  ...
  'PRIMER_MAX_LIBRARY_MISPRIMING'=>'(decimal,9999.99, default 12.00) Weighting for PRIMER_MISPRIMING_LIBRARY',
  'PRIMER_PAIR_MAX_LIBRARY_MISPRIMING'=>'(decimal,9999.99, default 24.00 Weighting for PRIMER_MISPRIMING_LIBRARY',
  ...
  'PRIMER_PICK_RIGHT_PRIMER'=>'(boolean, default 1) If the associated value is 1 (non-0), then primer3 will attempt to pick a right primer.',
  'PRIMER_PICK_LEFT_PRIMER'=>'(boolean, default 1) If the associated value is 1 (non-0), then primer3 will attempt to pick left primers.',
  'PRIMER_SALT_DIVALENT'=>'(float; default 0.0) The millimolar concentration of divalent salt cations (usually MgCl^(2+)) in the PCR.',
  'PRIMER_TM_FORMULA'=>'(int; default 0) Specifies details of melting temperature calculation.',
  'PRIMER_DEFAULT_PRODUCT' => '(size range list, default 100-300)',
  'PRIMER_PICK_INTERNAL'=>'(boolean, default 0) if set, a hybridization probe will be selected',
  ...
  'PRIMER_PAIR_MAX_DIFF_TM'=>'(float, default 100.0C) acceptable difference in Tms',
  ...
  'PRIMER_SALT_MONOVALENT'=>'(float, default 50.0 mM) Salt concentration required for Tm calcs.',
  'PRIMER_DNA_CONC'=>'(float, default 50.0 nM) DNA concentration required for Tm calcs. ',
  'PRIMER_MAX_NS_ACCEPTED'=>'(int, default 0) Maximum number of unknown bases (N) allowable in any primer.',
  'PRIMER_MAX_SELF_ANY'=>'(decimal,9999.99, default 8.00) Maximum aligment score for within and between primers when checking for hairpin loops',
  'PRIMER_MAX_SELF_END'=>'(decimal 9999.99, default 3.00) Maximum aligment score for within and between primers when checking for primer dimers',
  'P3_FILE_FLAG'=>'(boolean, default 0) Output <sequence_id>.for and <sequence_id>.rev with all acceptable forward and reverse primers',
  'PRIMER_MAX_POLY_X'=>'(int, default 5) The maximum allowable length of a mononucleotide repeat.',
  'PRIMER_LIBERAL_BASE'=>'(boolean, default 0) Use IUPAC codes (well, just change them to N). Note must also set PRIMER_MAX_NS_ACCEPTED',
  ...
  'PRIMER_MIN_QUALITY'=>'(int, default 0) Minimum sequence quality calculated from SEQUENCE_QUALITY',
  'PRIMER_MIN_END_QUALITY'=>'(int, default 0) Minimum sequence quality calculated from SEQUENCE_QUALITY at 5 prime 5 bases',
  'PRIMER_QUALITY_RANGE_MIN'=>'(int, default 0) Minimum sequence quality calculated from SEQUENCE_QUALITY',
  'PRIMER_QUALITY_RANGE_MAX'=>'(int, default 100) Maximum sequence quality calculated from SEQUENCE_QUALITY',
  ...
  'PRIMER_TASK'=>'(string, default pick_pcr_primers) Choose from pick_detection_primers, check_primers, pick_primer_list, pick_sequencing_primers, pick_cloning_primers, pick_discriminative_primers, pick_pcr_primers, pick_pcr_primers_and_hyb_probe, pick_left_only, pick_right_only, pick_hyb_probe_only',
  ...
  'SEQUENCE_INTERNAL_EXCLUDED_REGION'=>'(interval list, default empty) Internal oligos must ignore these regions',
  'SEQUENCE_INTERNAL'=>'(nucleotide sequence, default empty) Known sequence of an internal oligo',
  'PRIMER_INTERNAL_OPT_SIZE'=>'(int, default 20)',
  'PRIMER_INTERNAL_MIN_SIZE'=>'(int, default 18)',
  'PRIMER_INTERNAL_MAX_SIZE'=>'(int, default 27)',
  'PRIMER_INTERNAL_OPT_TM'=>'(float, default 60.0 degrees C)',
  'PRIMER_INTERNAL_OPT_GC_PERCENT'=>'(float, default 50.0%)',
  'PRIMER_INTERNAL_MIN_TM'=>'(float, default 57.0 degrees C)',
  'PRIMER_INTERNAL_MAX_TM'=>'(float, default 63.0 degrees C)',
  'PRIMER_INTERNAL_MIN_GC'=>'(float, default 20.0%)',
  'PRIMER_INTERNAL_MAX_GC'=>'(float, default 80.0%)',
  'PRIMER_INTERNAL_SALT_MONOVALENT'=>'(float, default 50.0 mM)',
  'PRIMER_INTERNAL_DNA_CONC'=>'(float, default 50.0 nM)',
  ...
  'PRIMER_INTERNAL_MISHYB_LIBRARY'=>'(string, optional)',
  'PRIMER_INTERNA_MAX_LIBRARY_MISHYB'=>'(decimal,9999.99, default 12.00)',
  'PRIMER_INTERNAL_MIN_QUALITY'=>'(int, default 0)',
  'PRIMER_INTERNAL_WT_TM_GT'=>'(float, default 1.0)',
  'PRIMER_IINTERAL_WT_TM_LT'=>'(float, default 1.0)',
  ...
  'PRIMER_PAIR_WT_TEMPLATE_MISPRIMING' => '(float, default 0.0) Penalty for a primer pair binding to the template sequence.',
  'PRIMER_WT_TEMPLATE_MISPRIMING' => '(float, default 0.0) Penalty for a single primer binding to the template sequence.',
  'PRIMER_PAIR_MAX_COMPL_ANY'=>'(decimal, 9999.99; default 8.00)  describes the tendency of the left primer to bind to the right primer',
  'PRIMER_PAIR_MAX_COMPL_END'=>'(decimal, 9999.99; default 3.00) tries to bind the 3-END of the left primer to the right primer and scores the best binding it can find',
  'PRIMER_INTERNAL_SALT_DIVALENT'=>'(float; default 0.0) Equivalent parameter of PRIMER_SALT_DIVALENT for the internal oligo.',
  'PRIMER_INTERNAL_MAX_NS_ACCEPTED'=>'(int; default 0) Equivalent parameter of PRIMER_MAX_NS_ACCEPTED for the internal oligo',
  'PRIMER_INTERNAL_DNTP_CONC'=>'(float; default 0.0) Equivalent parameter of PRIMER_DNTP_CONC for the internal oligo',
