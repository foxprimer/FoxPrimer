package FoxPrimer::Model::Available_Motifs;
use Moose;
...
FoxPrimer::Model::Available_Motifs - Catalyst Model
...
has motifs_file_list	=>	(
	is			=>	'ro',
	isa			=>	'Str',
	default		=>	'root/static/meme_motifs/list_of_motifs_by_gene.txt',
	required	=>	1,
);
...
sub motif_index {
	...
	open my $motifs_list_file, "<", $motifs_list_fh or die "Could not open $motifs_list_fh $!";
